...
function useScrollDirection({
    ...
    const [scrollDir, setScrollDir] = useState<ScrollDirectionEnum>(initialScrollDir);
    ...
    useEffect(() => {
        ...
        const updateScrollDir = () => {
            ...
            setScrollDir(scrollY < lastScrolly ? ScrollDirectionEnum.UP : ScrollDirectionEnum.DOWN);
